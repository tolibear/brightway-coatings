...
export default function ServiceAreaSection() {
  return (
    <section className="py-32 bg-gradient-to-b from-white via-blue-50 to-slate-50">
        ...
        <div className="mb-12">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {serviceAreas.map((area, index) => (
              <Card key={index} className={`group hover:shadow-lg transition-all duration-300 border-2 ${area.isHomeBase ? 'border-green-200 bg-green-50' : 'hover:border-blue-200'}`}>
